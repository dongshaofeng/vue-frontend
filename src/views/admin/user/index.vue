<template>
  <div class="app-container calendar-list-container">
    ...
    <el-table :key='tableKey' :data="list" v-loading="listLoading" element-loading-text="数据加载中..." border fit
              highlight-current-row style="width: 100%" :default-sort = "{ prop: 'id', order: 'descending'}">
      ...
      <el-table-column align="center" label="用户名">
        <template slot-scope="scope">
          <span>
            <img v-if="scope.row.avatar_url" class="user-picUrl" style="width: 20px; height: 20px; border-radius: 50%;" :src="scope.row.avatar_url">
            {{scope.row.username}}
          </span>
        </template>
      </el-table-column>
      ...
      <el-table-column align="center" label="创建时间" sortable prop="dateCreated" >
        <template slot-scope="scope">
      ...
      <el-table-column align="center" class-name="status-col" label="状态">
        <template slot-scope="scope">
          <el-tag>{{scope.row.record_status | statusFilter}}</el-tag>
        </template>
      </el-table-column>
      <el-table-column align="center" label="操作">
        ...
        <!--</template>-->
        <template slot-scope="scope">
          <el-button  size="small" type="success" @click="formEdit(scope.row)" v-waves>编辑</el-button>
          <el-button  size="small" type="danger" @click="handleDelete(scope.row)" v-waves>删除</el-button>
        </template>
      </el-table-column>
    </el-table>
