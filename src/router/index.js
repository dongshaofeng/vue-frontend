...
export const asyncRouterMap = [
  {
    ...
    children: [
      ...
      { menuId: 3, hidden: false, path: 'role', component: _import('admin/role/index'), name: 'menu_role', meta: { title: 'menu_role', icon: 'role' }},
      { menuId: 4, hidden: false, path: 'client', component: _import('admin/client/index'), name: 'menu_client', meta: { title: 'menu_client', icon: 'role' }}
